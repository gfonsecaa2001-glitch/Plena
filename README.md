...
- ✅ **Testes** — `npm test` (Vitest). Cobre nutrição, agendamento, plano alimentar, datas/fuso, busca de alimentos e dinheiro. `tests/isolamento.test.ts` precisa de `TEST_DATABASE_URL` (um branch do Neon) e fica pulado sem ela.
